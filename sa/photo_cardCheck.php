...
if(isset($_POST['submit_regNum'])){
    ...
    $query = "SELECT  photograph FROM onlineApplications WHERE RegNumber ='$regNum'";
...
<?php 
        ...
        $query = "SELECT * FROM onlineApplications WHERE RegNumber='$regNum'";
        $query = mysqli_query($con, $query) or die (mysqli_error($con));
                ...
                <main>
                    ...
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Applicant's PHOTOCARD: <div class="image_inner_container">
					                   &nbsp; &nbsp;  <img src="https://applications.escohsti-edu.ng/<?php if(isset($file_path)) { echo $file_path; } else { echo $dfaulti_img; } ?>">
				                    </div> <?php if($stst!=3){ echo '<font color="red">This Application is INCOMPLETE</font>';  } else { echo  '<font color="red">This Application is COMPLETED</font>'; } ?> </h3> </div>
				                    
                                     <div class="form-group">
                                            <div class="form-group mt-4 mb-0"><a  href="https://eportal.escohsti-edu.ng/staffArea/photo_cardCheck.php" name="printCourseForm" class="btn btn-primary btn-block"  style="width:40%;">Check Another</a></div>
                                             </div>
                                  <div class="small"><h3 class="text-center font-weight-light my-4">Exam Date is Scheduled to :THURSDAY, September 30th, 2021.<br />
                                    ...
                                    <div class="card-body">
                                        <form method="POST">
                                            <div class="form-row">
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputFirstName">Enter Reg Number</label>
                                                        <input class="form-control py-4" id="inputFirstName" type="text" placeholder="" name="regNum" value=""  placeholder="Enter Reg Number" required />
                                                    </div>
                                                </div>
                                                </div>
                                                <div class="form-row">
                                                <div class="col-lg-12">
                                                    <div class="form-group">
                                                        <input class="form-control btn btn-primary" id="submit_regNum" type="submit" placeholder="" name="submit_regNum" value="Submit" />
                                                    </div>
                                                </div>
                                                </div>
