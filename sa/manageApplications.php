...
//Get Id of Applicants To Edit
	$query =mysqli_query($con, "SELECT ID From OnlineApplications Where Username ='$username' OR RegNumber ='$regNum'");
	if(!$query){
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4"> Edit Applicant's Application Form Data</h3></div>
                                           ...
                                           <span style="color:green; font-size:18px;"><?php if(isset($msg)){ echo $msg; } ?></span>
                                               ...
                                               <div class="form-row">
                                                    ...
                                                    <div class="form-group">
                                                         <label class="small mb-1" for="inputFirstName">Registration Number</label> <span style="color:red; font-size:10px;">&nbsp; &nbsp; (* Enter The Student Matric ID Number To Edit*)</span>
                                                        <input class="form-control py-4" id="inputFirstName" type="text" placeholder="Enter Applicant's Registration Number" name="matricID" required  Value="<?php if(isset($matric)){ echo $matric; }  ?>" />
                                                    </div>
                                                </div>
                                                  <div class="col-md-6">
                                                    <div class="form-group">
                                          <div class="form-control py-4" ><button type="submit" name="editApp" class="btn btn-primary btn-block">Edit Applicants Details</div>
                                            </div>
                                            </div>
                                             </div>
                                        </form>
