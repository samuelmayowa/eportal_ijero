...
<html lang="en">
    <head>
        ...
        <title>Eportal-Admission- Admission List</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">UPDATE ADMISSION LIST </h3></div>
                                    <div class="card-body">
                                        <form action="uploadPUTMERe.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group mt-4 mb-0"><button type="submit" name="submit" class="btn btn-primary btn-block">UPDATE ADMISSION DATA</a></div>
                                        </form>
                                    </div>
                </main>
