...
//$pdf->SetTitle('The College Of Health Science And Tech', 'utf8(true)');
   ...
   // $pdf -> Line(80, 80, 30, 50);
    ...
    // Get Bio Data
     $pdf->Write(26,'UNCOMPLETED APPLICATION INVOICE REPORT: ');
...
//$pdf->Write(12, "Date Printed ". date('dd-mm-yyyy'));
 $mydate=getdate(date("U"));
 $pdf->Write(12, "Date Printed: ". $mydate[weekday].', '. $mydate[month]. '  ' . $mydate[mday].', '  .$mydate[year]);
$pdf->Ln(10);
$pdf->SetFont('Arial','',8);
