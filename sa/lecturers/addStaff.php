...
//Append Courses
 ...
 $addstaff = "INSERT INTO Staffs (StaffCode, Title, FirstName, 
        	Surname, Designation, Job_Role,PhoneNumber, DeptID) 
 VALUES ('$staffCode', '$stTitle', '$fname', '$lname',
         '$desig', '$jobs','$phno','$deptCode')";
                                        ...
                                        <form action="addStaff.php" method="POST" enctype="multipart/form-data">
                                           <span style="color:green; font-size:18px;"><?php if(isset($msg)){ echo $msg; } ?></span>
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" id="inputFirstName" type="text" placeholder="Enter Title" name="title" required />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" id="inputLastName" type="text" placeholder="Enter your Staff Code" name="staffCode"  required />
                                                    </div>
                                                </div>
                                                </div>
                                                <div class="form-row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="emailHelp" placeholder="Enter Your SurName" name="lname" required />
                                            </div>
                                            </div>
                                           <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="small mb-1" for="inputEmailAddress">First Name</label></label>
                                                <input class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="emailHelp" placeholder="Enter Your FirstName" name="fname" required />
                                            </div>
                                            </div>
                                            </div>
                                             <div class="form-row">
                                            ...
                                            echo $dc;
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" id="inputLastName" type="text" placeholder="Enter Staff Phone Number" name="phno"  required />
                                                    </div>
                                                </div>
                                                </div>
                                                <div class="form-row">
