            ...
            <a class="navbar-brand" href="dashboard.php?msg=<?php echo $_SESSION['userID']; ?>" style="color:#fff;"><?php if(isset($name)){ echo $name;  }else { echo 'ESCOHST-IJERO'; }  ?></a>
                                 <a class="nav-link" href="profiles.php?msg=<?php echo $_SESSION['userID']; ?>">
                                     <div class="image_inner_container">
					                   &nbsp; &nbsp;  <img src="<?php if(isset($pix)) { echo $pix; } else { echo $dfaulti_img; } ?>">
				                    </div>
				                </a>
            ...
            <ul class="navbar-nav ml-auto ml-md-0" style="color:#fff;">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="myProfiles.php?msg=<?php echo $id; ?>">Edit Profile</a>
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item" href="../logout.php?msg=<?php echo $id; ?>">Logout</a>
                    </div>
                </li>
            </ul>
        </nav>