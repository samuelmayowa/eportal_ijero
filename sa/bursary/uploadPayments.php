            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Import Existing Students payment Records</h3></div>
                                    <div class="card-body">
                                        <form action="uploadPayments.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputLastName">Department Name</label>
                                                        <input class="form-control py-4" id="inputLastName" type="text" placeholder="Enter Department" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="small mb-1" for="inputEmailAddress">Faculty/ School</label>
                                                <input class="form-control py-4" id="inputEmailAddress" type="text" aria-describedby="emailHelp" placeholder="Enter Faculty" />
                                            </div>
                                           
                                            <div class="form-group mt-4 mb-0"><button type="submit" name="submit" class="btn btn-primary btn-block">UPLOAD PAYMENTS</a></div>
                                        </form>
                                    </div>
                </main>
       ...
       // print_r($std->dimension(2));
        ...
        foreach ($std->rows($sheet) as $key => $row){
           // print_r($row);
            ...
            echo  '<script> alert ("Student payment Records imported Successfully");</script>';
