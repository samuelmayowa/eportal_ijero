            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4"> Update Fee Record</h3></div>
                                                        ...
                                                        <label class="small mb-1" for="inputFirstName">Payments Type(Fee Type)</label>
                                                         <select name="payType" class="form-control py-4" id="payType" size="1">
                                                            ...
                                                            <?php 
                                                                       ...
                                                                       $ci="";
                                                                       $lev="";
                                                                       $query = "SELECT payCategories, Department,Citizenship, Level FROM paymentCategories ORDER BY payCategories";
                                                            ...
                                                            while ($schl = mysqli_fetch_array($query)){
                                                                ...
                                                                echo "<option value='$payType'> ( $lev ) $payType ($dept) ( $ci )</option>";
                                                               } ?>
                                                            </select>
                                                    </div>
                                                </div>
