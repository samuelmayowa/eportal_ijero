            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Import POST UTME Jamb Data</h3></div>
                                    <div class="card-body">
                                        <form action="uploadJamb.php" method="POST" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <label class="small mb-1" for="inputfilename"> File Name:</label>
                                                <input class="form-control py-4" id="inputEmailAddress" type="file" name="stdjambdata"  required/>
                                           </div>
...
/*if(isset($_FILES['stdjambdata']['name'])){
    ...
    include("SimpleXLSX.php");
        ...
        $std=SimpleXLSX::parse($_FILES['stdjambdata']['tmp_name']);
        echo "<pre>"; 
        //print_r($std->rows(1));
       // print_r($std->dimension(2));
        //print_r($std -> sheetNames());
