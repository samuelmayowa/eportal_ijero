            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Manage Courses</h3></div>
                                   
                                     
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4" style="color:#28a745; font-family:Arial Black;"><img src="../../images/echstijero-logo.png"><br><a href="addSchools.php?msg=<?php echo $_GET['msg']; ?>">Add Schools(Faculties)</a> </h3></div>
                                    <div class="card-body">
                                     <div class="card-header"><h3 class="text-center font-weight-light my-4" style="color:#28a745; font-family:Arial Black;"><img src="../../images/courseBook.jpg"><br><a href="addDept.php?msg=<?php echo $_GET['msg']; ?>">Add Departments</a></div>
                                         <div class="card-header"><h3 class="text-center font-weight-light my-4" style="color:#28a745; font-family:Arial Black;"><img src="../../images/course-Units.png"><br><a href="addCourses.php?msg=<?php echo $user; ?>">Add Courses </a></h3></div> 
