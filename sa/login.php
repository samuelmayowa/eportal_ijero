    ...
    if(!$query){
      $msg= mysqli_error($con);
       ...
       if($loginUser =='PSWD_ADMIN'){
               header('location:passwordReset.php?msg='.$loginUser. 'user='.$user);
           }elseif($loginUser =='BURSAR'){
               header('location:manageFinance.php?msg='.$loginUser. 'user='.$user);
           }elseif($loginUser == 'HOD'){
               header('location:manageLectures.php?msg='.$loginUser. 'user='.$user);
           }
           elseif($loginUser == 'ADMIN_OFFICER'){
               header('location:admission/dashboard.php?msg='.$loginUser. 'user='.$user);
