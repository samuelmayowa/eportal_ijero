                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" id="inputFirstName" type="text" placeholder="Enter Staff Codes"  name="username" required  Value="<?php if(isset($username)){ echo $username; }  ?>" />
                                                    </div>
                                                </div>
                                               </div>
