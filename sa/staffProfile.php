...
if(!isset($_SESSION['userID'])){
    header('location:https://eportal.escohsti-edu.ng/staffArea/index.php?msg=Login in Properly');
}
$user="";
$citizen ="";
$st="";
...
if(isset($_POST['UpdateProfiles'])){
     ...
     $hrd=$screenData['hrd'];
      ...
      LGA ='$lga',State='$st', GuarantorNumber ='$grtNum', GuarantorName ='$grtName', HiredDate='$hrd',
      LastUpdated ='$tody' WHERE StaffCode ='$stdCode'";
          ...
          if(!$updateProfiles){
             ...
             header('location:staffPassport.php?msg=Upload Your Passport To Complete The Update Profile Challenge && user='. $_SESSION['userID']);
          }
                                               ...
                                               <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" id="inputDateHired" type="text" placeholder="Enter Date LIKE  YYYY-MM-DD" name="hrd"  Value="<?php if(isset($hiredDate)){ echo $hiredDate; } ?>" />
                                                    </div>
                                                </div>
