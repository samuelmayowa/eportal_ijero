...
if(isset($_POST['resetPswd'])){
     ...
     $matric = $screenData['matricNumber'];
     $email= $screenData['email'];
     $password = $screenData['password'];
     $hashed=sha1($password);
     $rsPswd = mysqli_query($con,"UPDATE students SET passKey  = '$hashed' WHERE matricNumber ='$matric'");
     if($rsPswd){
          $msg="<script> alert('Student Password Was Reset Successfully'); </script>";
                                ...
                                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                                    ...
                                    <div class="collapse" id="pagesCollapseError" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
                                        <nav class="sb-sidenav-menu-nested nav">
                                            ...
                                            <a class="nav-link" href="#3404.html">Process Results</a>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4"> Manage Student Password</h3></div>
                                 
                                    <div class="card-body">
                                        <form action="resetStdPassword.php" method="POST" enctype="multipart/form-data">
                                           <span style="color:green; font-size:18px;"><?php if(isset($msg)){ echo $msg; } ?></span>
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" id="inputFirstName" type="text" placeholder="Enter Matric Number" name="matricNumber" required  Value="<?php if(isset($matric)){ echo $matric; }  ?>" />
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputFirstName">Student Password</label>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputFirstName">Student Email</label> </label>
                                             ...
                                             <div class="form-group mt-4 mb-0"><button type="submit" name="resetPswd" class="btn btn-primary btn-block">RESET STUDENT PASSWORD</button></div>
                                             </div>
                                        </form>
