...
<?php
  ...
  $stfCode = $_SESSION['usr'];
$screenData = filter_var_array($_POST, FILTER_SANITIZE_STRING);
  // Initialize message variable
  $msg = "";
     $target_dir = "../studentArea/passports/";
...
&& $imageFileType != "gif" ) {
  ...
  $uploadOk = 0;
  	...
  	$sql = "UPDATE  students SET StdPassport='$target_file' WHERE matricNumber ='$stfCode'";
  	// execute query
