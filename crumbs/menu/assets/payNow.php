                ...
                <main>
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                        ...
                        ?>" required/>
                                             ...
                                             <input class="form-control py-4" id="std-Level" name="stdLevel" type="text" placeholder="Your Level"  value="<?php if(isset($_SESSION['stdLevel'])){
                            echo $_SESSION['stdLevel'];
                        }
                        ?>" readonly required/>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputSemester">Semester</label>
                                                         <select name="semester" class="form-control py-4" id="inputFirstName" size="1" readonly>
                                                            <option value="<?php if(isset($_SESSION['semester'])){
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputFirstName">Course CODE</label>
                                                         <select name="courseCode" class="form-control py-4" id="inputFirstName" size="1" readonly>
                                                           <option value="<?php if(isset($_SESSION['courseCode'])){
                                                                echo $_SESSION['courseCode'];
                                                            }
                                                            ?>"><?php if(isset($_SESSION['courseCode'])){
                                                                echo $_SESSION['courseCode'];
                                                            }
                                                            ?></option>
                                                                        </select>
                        ...
                        ?>" readonly required/>
                                         ...
                                         <input class="form-control py-4" id="amount" name="amount" type="text" placeholder="amount"  value="<?php if(isset($_SESSION['amount'])){
