...
<form method="POST" action="generateInvoice.php?" >
    <ul class="form-style-1">
        ...
        <li>
         ...
         <li>
            <label>MatricNumber <span class="required">*</span></label>
            <input type="email" id="js-email" value="<?php if(isset($_SESSION['userID'])){
                            echo $_SESSION['userID'];
                        }
                        ?>"  readonly required name="email" class="form-control py-4"/>
        </li>
        ...
        <li>
            <input type="submit"  name="generate_rrr" value="Generate RRR"/>
        </li>
    </ul>
</form>
...
<!--<script src="https://code.jquery.com/jquery-3.5.1.slim.min.js" crossorigin="anonymous"></script>-->
    ...
    function clickButton() {
      ...
      s.src = "rrr-generate-schoolfess.php?user=<?php echo $user;?>&amt=<?php echo $amtk?>&desc=<?php echo $descrip;?>";
