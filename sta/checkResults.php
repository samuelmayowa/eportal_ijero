            ...
            <ul class="navbar-nav ml-auto ml-md-0" style="color:#fff;">
                ...
                <main>
                    ...
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">STUDENT Results Slip For 2020/21</h3> <button  type="button" name="printCourseForm" class="btn btn-primary btn-block" onclick="window.print();" style="width:40%;">Print This Page</button></div>
                                    ...
                                    <div class="form-row">
                                            ...
                                            <div class="col-md-6">
                                                    <div class="form-group">
                                            <div class="form-group mt-4 mb-0"><button type="submit" name="printCourseForm" class="btn btn-primary btn-block"><a href="#printCourseForm.php?std=<?php echo $_GET['stdM']; ?>" style="color:#fff;" onclick="window.print();">Print Resluts Slip</a></button></div>
                                             </div>
                                             </div>
                                             <div class="col-md-6">
                                                    <div class="form-group">
