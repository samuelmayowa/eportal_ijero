...
require_once('../connection.php');
$payID="";
if(isset($_GET['dr']) != $_SESSION['check'] || !$_GET['dr']){
    header("location:dashboard.php?msg=Incorrect or data was compromised!") ;
}
...
<html lang="en">
    ...
    <body >
            ...
            <ul class="navbar-nav ml-auto ml-md-0" style="color:#fff;">
                ...
                <main>
                    ...
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body" id="hide_print">
                                        <p>Click the button below to down letter of undertaking before you can proceed to print receipt </p>
                                        <div class="form-group mt-4 mb-0">
                                            <a class="btn btn-primary btn-block" download id="printclick" href="letter/STUDENT UNDERTAKING LETTER.pdf" style="color:#fff; font-size:18px; padding:5px;" target="_new">Print Under Taken</a>
                                            </div>
                                    </div>
                                  
                                    <div class="card-body"id="show_data" style="display:none">
                                        ...
                                        <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" id="inputFirstName" type="text" placeholder="" name="signature" value="<?php if(isset($_SESSION['RRR'])){ echo $_SESSION['RRR']; } ?>"  readonly required />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" id="inputFirstName" type="text" placeholder="Payment Description" name="description" value="<?php  if(isset($_SESSION['DESC'])) { echo $_SESSION['DESC']; } ?>"  readonly required />
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" id="inputFirstName" type="text" placeholder="" name="signature" value="<?php echo  $_SESSION['SESSION']; ?>"  readonly required />
                                                    </div>
                                                </div>
                                                </div>
                                    ...
                                    <div class="form-row">
                                            ...
                                            <div class="col-md-6">
                                             ...
                                             <div class="col-md-6">
                                                ...
                                                <div class="form-group mt-4 mb-0"><button type="button" name="printCourseForm" class="btn btn-primary btn-block"><a href="generateReceipts.php?msg=<?php echo $_SESSION['RRR']; ?>&matric=<?php echo $stdCode;?>" style="color:#fff; font-size:18px; padding:5px;" target="_new">Print Receipts</a></button></div>
                                        </form>
                                    </div>
                                    </div>
                                    </div>
        ...
        <script>
            $("#printclick").click(function(event){
                $("#hide_print").html("Please wait for 6secs");
                setTimeout(function() { 
                    $("#hide_print").hide();
                    $("#show_data").show();
                }, 6000);
