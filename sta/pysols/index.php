...
if(isset($_POST['std'])){
     ...
     $matricID = $screenData['matric'];
     $passky= $screenData['passwd'];
    $encr =sha1($passky);
     
    /*if(isset($matricID)){
$payID = getPayId($con,$matricID);
} else {
    if(empty($payID)){
    ...
    header("location:myProfiles.php?msg=Your first Login, <br>Complete Your OutStanding Fees To Complete Courses Registration") ;
   } 
   else{
    $query = "Select matricNumber, passKey FROM students WHERE matricNumber='$matricID' AND passKey = '$encr' LIMIT 1";
    ...
    if(!$query){
      $msg= mysqli_error($con);
        ...
        while($results=mysqli_fetch_array($query)){
          ...
          header("location:dashboard.php?msg=Welcome!, Have You Completed Your Course Registration? && userId=$matricID");
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <div class="card-header"><h3 class="text-center font-weight-light my-4" style="color:#28a745; font-family:Arial Black;"><img src="../images/logo-banner.png" width="90%"></h3></div>
                                <div class="card-header"><h3 class="text-center font-weight-light my-4" style="color:#28a745; font-family:Arial Black;"><img src="../images/std-icon-2.jfif"><br>STUDENT LOGIN </h3></div>
                                    <div class="card-body">
                                        ...
                                        <form method="POST" action="index.php">
                                            <div class="form-group"> <span style="color:maroon; font-size:10px;" ><?php if(isset($msg)){ echo $msg; } ?> <?php if(isset($_GET['msg'])){ echo $_GET['msg']; } ?> </span><br />
                                                <label class="small mb-1" for="inputEmailAddress">Your Matric Number</label>
                                                <input class="form-control py-4" id="inputFirtName" type="text" placeholder="Enter MatricNumber" name="matric" />
                                            </div>
