...
<form onsubmit="makePayment()" id="payment-form">
    <ul class="form-style-1">
        <li>
            ...
            <input type="text" id="js-firstName" name="firstName" class="form-control py-4" placeholder="First"/>&nbsp;
            <input type="text" id="js-lastName" name="lastName" class="form-control py-4" placeholder="Last"/>
        </li>
        <li>
            <label>Email <span class="required">*</span></label>
            <input type="email" id="js-email" name="email" class="form-control py-4"/>
        </li>
        <li>
            <label>Narration <span class="required">*</span></label>
            <input type="text" id="js-narration" name="narration" class="form-control py-4"/>
        </li>
        <li>
            <label>Amount <span class="required">*</span></label>
            <input type="number" id="js-amount" name="amount" class="form-control py-4"/>
        </li>
        <li>
