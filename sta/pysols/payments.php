...
if($stdCat = mysqli_query($con,"Select StdType From students WHERE matricNumber ='$user'")){
    while ($cat = mysqli_fetch_array($stdCat)){
        $stdCategory = $cat['StdType'];
    }
}
                                        ...
                                        <form action="payments.php" method="POST" id="paymentForm">
                                           <span style="color:green; font-size:18px;"><?php if(isset($msg)){ echo $msg; } ?></span>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputFirstName"> Course Of Study</label></label>
                                                         <input class="form-control py-4" id="inputFirstName" type="text" placeholder="Phone Number" name="courseCode" value="<?php if(isset($_SESSION['dept'])){ echo $_SESSION['dept']; } ?>" required />
                                                    </div>
                                                </div>
                                            ...
                                            <!--<div class="form-row">-->
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="amount">Payment Amount</label>
