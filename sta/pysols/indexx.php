...
if(isset($_POST['login'])){
    ...
    $schlID ='';
	      ...
	      header('location:myProfiles.php?user='.$username);
	          }
	          }
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="indexx.php" Method="POST" >
                                            ...
                                            <div class="form-group d-flex align-items-center justify-content-between mt-4 mb-0">
                                                ...
                                                <button class="btn btn-primary"  name="login" type="submit">Student Login</button>
                                            </div>
                                        </form>
                                    </div>
                                    <div class="card-footer text-center">
                                        <div class="small"><a href="http://applications.escohsti-edu.ng/index.html">Need an account? Sign up!</a></div>
                                    </div>
                                </div>
                            </div>
                        </div>
