                ...
                <main>
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                        ...
                        ?>" readonly required/>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                      ...
                                                      <?php 
                                                            ...
                                                            while ($schl = mysqli_fetch_array($qry)){
                                                                // $amountPayab = $schl ['Amountpayable'];
                                         ...
                                         <input class="form-control py-4" id="amount" name="amount" type="text" placeholder="amount"  value="<?php if(isset($amt)){
                                                                echo $amt;
                                                            }
                                                            ?>" readonly required/>
                                                    </div>
