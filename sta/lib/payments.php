                ...
                <main>
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                        ...
                        ?>" readonly required/>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="amount">Student Phone Number</label>
                                                     
                                         <input class="form-control py-4" id="phno" name="stdPhno" type="text" placeholder="Student Phone Number"  value="<?php if(isset($_SESSION['stdPhno'])) { echo  $_SESSION['stdPhno']; } ?>"  required/>
                                                    </div>
                                                </div> 
                                         </div>
                                            <div class="col-md-6">
