...
$screenData = filter_var_array($_POST, FILTER_SANITIZE_STRING);
  ...
  if (isset($_POST['UpdatePassport'])) {
  	...
  	$target = "passports/".basename($image);

  	$sql = "UPDATE  students SET StdPassport='$image' WHERE matricNumber ='$stdCode'";
  	// execute query
                                           ...
                                           <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <span style="color:red; font-size:20px;">ENsure Your Passport File is Saved with Your Matric Number</span>
                                                    </div>
                                                </div>
                                           <div class="form-group">
                                               <div class="col-lg-*">
