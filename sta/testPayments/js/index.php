...
if(isset($_POST['std'])){
    ...
    $query = "Select matricNumber, passKey FROM students WHERE matricNumber='$matricID' OR passKey = '$passky'";
    ...
    if(!$query){
      $msg= mysqli_error($con);
        ...
        while($results=mysqli_fetch_array($query)){
           ...
           elseif($passkey == 'password1'){
                $_SESSION['userID'] =$user;
               header('location:myProfiles.php?msg=You Login in For The First Time');
           }
           
          else {
               $msg="Your Username and Pasword Not Match " .$passw;
           }
        } 
    }
}
