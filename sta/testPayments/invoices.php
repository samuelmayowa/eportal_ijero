...
//require_once('../../rrr_func.php');
 ...
 $type_Paid = '2020/2021 Application Form';
   ...
   // $statusCode = $rrdata_notPaid['rrr_statuscode'];
    ...
    header("location:generate-rrr.php");
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-12">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Generate Invoice For 2021/2022 School Fees Payments</h3></div>
                                    <div class="alert"></div>
                                    <!--<button onclick="clickButton()">Click me!</button>-->
                                        ...
                                        <p id="status"></p>
                                    <div class="card-body">
                                        <form action="generate-rrr.php" method="POST"> 
                                            <div class="form-row">
                                                <div class="col-md-6">
                                            ...
                                            <div class="form-row">
                                               <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" id="inputPayingFor" name="payingFor" type="text" placeholder="What Are You Paying For?" value="SCHOOL TUITION FEES"  readonly/>
                                                    </div>
                                                </div>
