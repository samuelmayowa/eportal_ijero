...
if(isset($_POST['payments'])){
    ...
    $screenData = filter_var_array($_POST, FILTER_SANITIZE_STRING);
                            ...
                            header('location:invoices.php?userID='.$matricNumber);
                            }
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="card shadow-lg border-0 rounded-lg mt-5">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputSemester">Semester</label>
                                                         <select name="semester" class="form-control py-4" id="inputFirstName" size="1">
                                                            <option value="Select Semester">....Select Payment Type...</option>
                                                            <option value="Full Tuition Payment">FULL Payment</option>
                                                            <option value="Initial(Part) Payment">Part Payment(Initial Payment)</option>
                                                            </select>
                                                             </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputFirstName"> Course Of Study</label></label>
                                                         <input class="form-control py-4" id="inputFirstName" type="text" placeholder="Phone Number" readonly name="courseCode" value="<?php if(isset($_SESSION['dept'])){ echo $_SESSION['dept']; } ?>" required />
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <!--<input class="form-control py-4" id="inputPassword" name="progCat" type="text" placeholder="Undergrate or Post Graduate"  required/>-->
                                                         <select name="payType" class="form-control py-4" id="payType" size="1">
                                                            ...
                                                            <?php 
                                                                    $stdLevel=  $_SESSION['stdLev'];
                                                                    $citizen=$_SESSION['citizen'];
                                                                    $amountPayable="";
                                                                       $payType="";
                                                          if(empty($citizen) && empty($stdLevel)){
                                                                    $stdLevel=  '100';
                                                                    $citizen='NON-INDIGENE';
                                                                     echo  header('location:myProfiles.php?msg=You have not Updated Your Profile');
                                                                       $query = "SELECT payCategories FROM paymentCategories Where  Level LIKE '$stdLevel%'  AND  Citizenship='$citizen'    ORDER BY payCategories";
                                         ...
                                         <!--<input class="form-control py-4" id="fees" name="fees" type="text" placeholder="Student Phone Number"  value="<?php if(isset($_SESSION['stdPhno'])) { echo  $_SESSION['stdPhno']; } ?>"  required/>-->
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" id="inputFirstName" type="text" placeholder="amount"  name="dept" readonly  value="<?php if(isset($_SESSION['dept'])){ echo $_SESSION['dept']; } ?>" />
                            ...
                            echo $_SESSION['userID']; } ?>" readonly required/>
                                                    </div>
                                                </div>
                                         </div>
                                            <div class="col-md-6">
                                            ...
                                            <button type="submit" name="payments" class="btn btn-primary btn-block"> Generate Invoice Payment Now </button>
