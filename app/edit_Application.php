                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                         <div class="form-group">
                                            <div class="form-group mt-4 mb-0"><button type="button" name="printCourseForm" class="btn btn-primary btn-block"><a href="https://applications.escohsti-edu.ng/applications.php?msg=<?php echo $payID;  ?> && payID=<?php echo $payID; ?>" style="color:#fff; font-size:18px; padding:5px;" target="_new">Edit Application</a></button></div>
                                             </div>
                                             </div>
                                             <div class="col-md-6">
                                                <div class="form-group">
